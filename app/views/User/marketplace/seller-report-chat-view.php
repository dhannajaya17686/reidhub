  ...
  <nav class="breadcrumb" aria-label="Breadcrumb">
    <ol class="breadcrumb__list">
      <li class="breadcrumb__item">
        <a href="/dashboard/marketplace/seller/orders" class="breadcrumb__link">Seller Orders</a>
      </li>
  ...
  <div class="chat-container">
    <aside class="chat-sidebar">
      <div class="order-details-card">
        ...
        <div class="detail-section">
          <h3 class="section-subtitle">Reported Item</h3>
          <?php
        ...
        <div class="detail-section">
          <h3 class="section-subtitle">Report Reason</h3>
        ...
        <div class="detail-section">
          ...
          <div class="participant">
            ...
            <div class="participant-name">Moderation Team</div>
          </div>
          <div class="participant">
            <div class="participant-role">Seller</div>
            <div class="participant-name"><?php echo htmlspecialchars(trim((string)$report['seller_first_name'] . ' ' . (string)$report['seller_last_name'])); ?> <span class="you-badge">(You)</span></div>
          </div>
        </div>
      </div>
    </aside>
    ...
    <section class="chat-section">
      ...
      <form class="chat-input-form" id="chatForm">
        ...
        <div class="input-group">
          <textarea id="messageContent" name="content" class="message-input" placeholder="Type your message for admin..." rows="3" maxlength="5000" required></textarea>
...
<script type="module">
  ...
  const API_BASE = '/dashboard/marketplace/seller/reported';
