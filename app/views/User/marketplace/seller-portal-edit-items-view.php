...
<main class="add-items-main" role="main" aria-label="Edit Item Form">
  ...
  <!-- Edit Item Form -->
  <form class="add-item-form" id="edit-item-form" method="POST" action="/marketplace/seller/edit-item/1" enctype="multipart/form-data">
    ...
    <div class="form-section">
      ...
      <div class="form-group">
        ...
        <div class="radio-group">
          <label class="radio-option">
            <input type="radio" name="condition" value="brand_new" checked required>
      ...
      <div class="form-group">
        ...
        <textarea 
          ...
          required
          maxlength="500"
        >High quality UCSC branded t-shirt in excellent condition. Perfect for university events and casual wear.</textarea>
        <div class="char-counter">
          <span id="desc-count">96</span>/500 characters
        </div>
      ...
      <div class="form-group">
        ...
        <div class="checkbox-group">
          <label class="checkbox-option">
            <input type="checkbox" name="payment_methods[]" value="cash_on_delivery" id="cod-option" checked>
          ...
          <label class="checkbox-option">
            <input type="checkbox" name="payment_methods[]" value="preorder" id="preorder-option" checked>
            <span class="checkbox-custom"></span>
            <div class="checkbox-content">
      ...
      <div class="bank-details-section" id="bank-details-section">
        ...
        <div class="form-grid">
          ...
          <div class="form-group">
            ...
            <select id="bank-name" name="bank_name" class="form-select" required>
              <option value="">Select Bank</option>
              <option value="commercial_bank" selected>Commercial Bank of Ceylon</option>
        ...
        <div class="bank-preview" id="bank-preview">
          <h4 class="preview-title">Bank Account Preview</h4>
          <div class="preview-details">
            <div class="preview-item">
              <span class="preview-label">Bank:</span>
              <span class="preview-value" id="preview-bank">Commercial Bank of Ceylon</span>
            </div>
            <div class="preview-item">
              <span class="preview-label">Branch:</span>
              <span class="preview-value" id="preview-branch">Nugegoda</span>
            </div>
            <div class="preview-item">
              <span class="preview-label">Account Name:</span>
              <span class="preview-value" id="preview-account-name">John Doe</span>
            </div>
            <div class="preview-item">
              <span class="preview-label">Account Number:</span>
              <span class="preview-value" id="preview-account-number">8001234567890</span>
            </div>
          </div>
        </div>
      </div>
